...
function Upload() {
  ...
  const handleGenerateQuestions = async () => {
    ...
    try {
      // Upload files
      const uploadResponse = await fetch('https://mock-interview-backend-4.onrender.com/api/upload', {
        method: 'POST',
        body: formData,
      });
      ...
      // Get questions
      const questionsResponse = await fetch('https://mock-interview-backend-4.onrender.com/api/questions');
